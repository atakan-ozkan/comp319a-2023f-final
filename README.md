...
In note section, we have a search box with advanced filters. 
...
In calendar and events section, we used calendar library of Java, Holiday Api from Rapid Api and other libraries of Java to time convert.
